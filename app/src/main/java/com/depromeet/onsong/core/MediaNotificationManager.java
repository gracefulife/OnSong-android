  ...
  public MediaNotificationManager(MusicService service) {
    ...
    mPlayAction =
        new NotificationCompat.Action(
            com.depromeet.media.R.drawable.ic_play_arrow_white_24dp,
            mService.getString(com.depromeet.media.R.string.label_play),
            playIntent);
    mPauseAction =
        new NotificationCompat.Action(
            com.depromeet.media.R.drawable.ic_pause_white_24dp,
            mService.getString(com.depromeet.media.R.string.label_pause),
            pauseIntent);
    mNextAction =
        new NotificationCompat.Action(
            com.depromeet.media.R.drawable.ic_skip_next_white_24dp,
            mService.getString(com.depromeet.media.R.string.label_next),
            nextIntent);
    mPrevAction =
        new NotificationCompat.Action(
            com.depromeet.media.R.drawable.ic_skip_previous_white_24dp,
            mService.getString(com.depromeet.media.R.string.label_previous),
            prevIntent);
